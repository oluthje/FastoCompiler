...
# was:	li	_divide_R_35_, 2
	li	x10, 0
# was:	li	_times_L_32_, 0
	bne	x12, x10, l.falseLabel_36_
# was:	bne	_divide_R_35_, _times_L_32_, l.falseLabel_36_
	li	x10, 6
# was:	li	x10, 6
	la	x11, m.DivZero
...
# was:	sw	_size_68_, 0(_let_a2df_67_)
	addi	x21, x19, 4
# was:	addi	_addrg_75_, _let_a2df_67_, 4
	mv	x20, x0
# was:	mv	_i_76_, x0
	addi	x24, x11, 4
# was:	addi	_in_elem_70_, _arr_69_, 4
	addi	x23, x0, 0
# was:	addi	_filter_counter_72_, x0, 0
l.loop_beg_77_:
	bge	x20, x18, l.loop_end_78_
# was:	bge	_i_76_, _size_68_, l.loop_end_78_
	lw	x10, 0(x24)
# was:	lw	_res_73_, 0(_in_elem_70_)
	lw	x22, 0(x24)
# was:	lw	_out_elem_71_, 0(_in_elem_70_)
	addi	x24, x24, 4
# was:	addi	_in_elem_70_, _in_elem_70_, 4
	mv	x12, x10
# was:	mv	_arr_81_, _res_73_
	lw	x11, 0(x12)
...
# 	mv	_res_73_,_fun_arg_res_79_
	beq	x10, x0, l.filter_failed_74_
# was:	beq	_res_73_, x0, l.filter_failed_74_
	sw	x22, 0(x21)
# was:	sw	_out_elem_71_, 0(_addrg_75_)
	addi	x21, x21, 4
